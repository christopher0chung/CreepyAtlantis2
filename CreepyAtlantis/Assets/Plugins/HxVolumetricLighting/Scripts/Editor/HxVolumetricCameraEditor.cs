...
public class HxVolumetricCameraEditor : Editor  
{
    ...
    private SerializedProperty m_FeedbackMin;
    private SerializedProperty m_FeedbackMax;
    ...
    private void OnEnable()
    {
        ...
        m_FeedbackMin = serializedObject.FindProperty("FeedbackMin");
        m_FeedbackMax = serializedObject.FindProperty("FeedbackMax");
    ...
    public override void OnInspectorGUI()
    {
        ...
        if (cam != null)
        {
            ...
            {
                Warning += "HDR Disabled, Will map to LDR automatically";
                mt = MessageType.Info;


                //GUILayout.Label("HDR Disabled, Will map to LDR automatically");
            }
        }
        ...
        if (EditorGUILayout.BeginFadeGroup(m_ShowTemporal.faded))
        {
            ...
            EditorGUILayout.PropertyField(m_FeedbackMin);
            EditorGUILayout.PropertyField(m_FeedbackMax);
        }
        EditorGUILayout.EndFadeGroup();
