...
public class DialogueLine : MonoBehaviour, IDialogue, IControllable {
    ...
    private void Start()
    {
        _fsm = new FSM<DialogueLine>(this);
    ...
    private class BasicState : FSM<DialogueLine>.State
    {
        public string name;
    }
