    ...
    SubShader {
        ...
        Pass {
            ...
            VertexOutput vert (VertexInput v) {
                ...
                float4 node_7482 = _Time + _TimeEditor;
                float4 node_7914 = _Time + _TimeEditor;
                v.vertex.xyz += float3(0.0,((sin(((0.5*(mul(unity_ObjectToWorld, v.vertex).g+mul(unity_ObjectToWorld, v.vertex).b))+(node_7482.g*(-1.0))))*0.2)/objScale.g),((sin(((2.0*(mul(unity_ObjectToWorld, v.vertex).r+mul(unity_ObjectToWorld, v.vertex).b))+(node_7914.g*(-3.0))))*0.2)/objScale.r));
